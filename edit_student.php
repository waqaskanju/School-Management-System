          ...
          <div class="row mt-1 p-3 bg-white">
            ...
            <label for="status" class="form-label">Status</label>
              <div class="form-check">
                ...
                id="active_id" <?php if ($status=="active") { echo "checked";} ?> >
                <label class="form-check-label" for="active_id">Active</label>
              </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="status" value="struck off" 
              id="struckoff_id" <?php if ($status=="struck off") { echo "checked";} ?> >
            ...
            <div class="form-check">
              ...
              id="graduate_id" <?php if ($status=="graduate") { echo "checked";} ?> >

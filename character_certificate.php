...
<div class="container">
  ...
  <div class="top-center-school-name color-black">
      ...
      <p class="school-address">Chitor, District Swat</p>
      <h4 class="text-uppercase mt-3 mb-3"><u>Character Certificate</u></h3>
  </div>

  <div class="centered color-black">
    <p class="text-body">This is to certify that <u><b class="first-word-capital">
      Mr. <?php echo $name1; ?></b></u> Son of
      <span class="full-word"><u><b class="first-word-capital">Mr. &nbsp; <?php echo $fname1?></b></u></span>
      has been  a regular
      student of  class 10 in the session 2024-25<?php // echo $session1;?>. During his stay at the school,
...
<div class="container">
  ...
  <div class="centered color-black">
    <p class="text-body">This is to certify that <u><b class="first-word-capital">
      ...
      has been  a regular
      student of  class 10 in the session 2024-25<?php // echo $session2;?>. During his stay at the school,
      he has been obedient, hardworking and punctual. He has good moral character.<br>
      I wish him success in the future.
    </p>
  </div> <!--end of central container-->

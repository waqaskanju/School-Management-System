<?php
  /**
   * Admission No and Contact No List
   * php version 8.1
   *
   * @category Student
   *
...
$link=$LINK;
Page_header('Admission / Contact List');
...
<?php require_once 'nav.html';?>
  <div class="bg-warning text-center no-print">
    <h4>Show Class Admission/Contact Information</h4>
  </div>
      ...
      <div class="col-md-12 ">
        <table class="table" border="1">
          <tr class="border border-dark">
            ...
            <td class="border border-dark fw-bolder">Admission No</td>
            ...
            <td class="border border-dark fw-bolder">Address</td>
            <?php
            if ($status=="both") {
                echo '<td>Class</td>';
            }
               ...
               $Roll_No=$qfa['Roll_No'];
                ...
                <td class="border border-dark fw-bolder">'.$Roll_No. '</td>
                   <td class="border border-dark fw-bolder">'.$qfa['Name']. '</td>
                          ...
                          <td class="border border-dark fw-bolder">'.$qfa['Address']. '</td>
                        </tr>';

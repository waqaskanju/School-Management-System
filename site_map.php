...
<div class="col-6">
    <ul>
        ...
        <li>
            <a href="class_test_ayaz.php">Class Test Ayaz</a>
            Manual class name required
        </li>
        <li><a href="class_test.php">Class Test</a>  Manual class name required </li>
        <li>
            <a href="class_wise_age.php">Class wise age</a>
            Age Range of a class
        </li>
        ...
        <li>
            <a href="empty_marks_table.php">Empty Marks Table</a>
             Dummy Page having query for munual entry into Database.</li>
        <li>
            <a href="empty_position_column.php">Empty Position Column</a>
...
<li><a href="logout.php">Logout Page</a> </li>
        ...
        <li>
            <a href="roll_no_slip.php">Roll No Slip</a>
             Print Roll No slip of a class.</li>
        <li>

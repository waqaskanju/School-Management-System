    ...
    <form class="p-3" action="#" method="POST" onsubmit=save_rollno()>
      ...
      <div class="row mt-1 bg-white p-3">
        ...
        <div class="form-group col-md-4">
          ...
          name="admission_no" min="0" max="999999" step="1" value="0" 
          placeholder="Type date of admission no" onfocusout="check_admission_no()" 
          required>
        </div>
        <div class="form-group col-md-4">
          ...
          name="date_admission" min="2000" max="2030" step="1" value="2022" 
      ...
      <div class="row mt-1 p-3 bg-white">
        <div class="form-group col-md-4">
          ...
          <div class="form-check">
            ...
            value="Male" id="male_id" checked>
            <label class="form-check-label" for="male_id">Male</label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="radio" name="gender" 
            value="Female" id="female_id">
        ...
        <div class="form-group col-md-4">
            <label for="status" class="form-label">Status</label>
              <div class="form-check">
                ...
                value="active" id="active_id" checked >
                <label class="form-check-label" for="active_id">Active</label>
              </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="status" 
              value="struck off" id="struckoff_id" >
              <label class="form-check-label" for="struckoff_id">Struck Off</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="status" 
              value="graduate" id="graduate_id">
              <label class="form-check-label" for="graduate_id">Graduate</label>
            </div>
            </div>
      </div>

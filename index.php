    ...
    <div class="col-sm-4">
      ...
      <div class="card mb-4">
        <div class="card-body">
          ...
          <aside class="row">
            <div class="col-sm-3">
              <a href="add_student.php" class="btn btn-primary btn-lg">
               <i class="bi bi-person-plus"></i> Add Student
              </a>
            </div>
            <div class="col-sm-3">
              <a href="edit_student.php" class="card-link btn btn-warning btn-lg">
              <i class="bi bi-pencil-square"></i> Edit Student
              </a>
            </div>
            <div class="col-sm-3">
              <a href="delete_student.php" class="card-link btn btn-danger btn-lg">
    ...
    <div class="col-sm-4">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <aside class="row">
            <div class="col-sm-4">
              <a href="subject_link.php" class="btn btn-primary btn-lg">
                Add Exam Marks
              </a>
            </div>
            <div class="col-sm-4">
              <a href="add_all_subjects_marks.php" 
                ...
                Batch Add Exam Marks
              </a>
            </div>
            <div class="col-sm-4">
              <a href="update_all_subjects_marks.php" 
                  class="card-link btn btn-warning btn-lg">
                  Batch Edit Exam Marks
              </a>
            </div>
    ...
    <div class="col-sm-4">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <aside class="row">
            <div class="col-sm-4">
              <a href="class_result.php" class="btn btn-primary btn-lg">
                View Class Result
              </a>
            </div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
              <a href="calculate_position.php" 
                 class="card-link btn btn-danger btn-lg">
                  Add Position to DMC
              </a>
            </div>
          </aside>  <!-- Card Button Placment Row -->
      ...
      <div class="card mb-4">
        <div class="card-body">
          ...
          <aside class="row">
            ...
            <div class="col-sm-3">
              <a href="change_password.php" class="card-link btn btn-danger btn-lg">
    ...
    <div class="col-sm-4">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <aside class="row">
            <div class="col-sm-4">
              <a href="add_class_subject" class="btn btn-primary btn-lg">
    ...
    <div class="col-sm-4">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <aside class="row">
            <div class="col-sm-3">
              <a href="award_list.php" class="btn btn-primary btn-lg">
    ...
    <div class="col-sm-4">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <aside class="row">
            <div class="col-sm-4">
              <a href="site_map.php" class="btn btn-primary btn-lg">
    ...
    <div class="col-sm-4">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <aside class="row">
            <div class="col-sm-4">
              <a href="seating_plan.php" class="btn btn-primary btn-lg">
